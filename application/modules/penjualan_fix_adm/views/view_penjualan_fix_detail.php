    ...
    <section class="content-header">
      <h1>
        Detail Penjualan Fix
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Data Transaksi</a></li>
        <li>Penjualan Fix</li>
        <li class="active">Detail Penjualan Fix</li>
      </ol>
    </section>
              ...
              <div class="table-responsive">
                ...
                <div class="col-xs-12" style="padding-bottom: 20px;">
                  ...
                  <div style="padding-top: 30px; padding-bottom: 10px;">
                    <a class="btn btn-sm btn-default" title="Kembali" onclick="javascript:history.back()"><i class="glyphicon glyphicon-menu-left"></i> Kembali</a>

                    <?php $id = $this->uri->segment(3); ?>
                    <?php echo '<a class="btn btn-sm btn-primary" href="javascript:void(0)" title="Confirm" onclick="bukaFormEmail('."'".$id."'".')"><i class="glyphicon glyphicon-envelope"></i> Email</a>';?>
                    <?php echo '<a class="btn btn-sm btn-danger" href="javascript:void(0)" title="Confirm" onclick="batalkanKonfirmasi('."'".$id."'".')"><i class="glyphicon glyphicon-remove"></i> Batalkan</a>';?>
                  </div>
              </div>  
            </div>
            <!-- /.box-body -->
